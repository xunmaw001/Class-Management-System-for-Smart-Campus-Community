	...
	<body>
		<div id="app">
			...
			<div id="breadcrumb">
				...
				<span class="cn">留学交流</span>
			</div>
			<!-- 标题 -->

			<div class="forum-container" :style='{"width":"100%","padding":"30px 20px 40px","margin":"10px auto","position":"relative","background":"rgba(255,255,255,.3)"}'>
				<form class="layui-form login-form">
					<div class="layui-form-item" :style='{"alignItems":"center","margin":"0 0 10px 0","display":"flex"}'>
						<div :style='{"width":"120px","padding":"0 15px","lineHeight":"40px","textAlign":"right"}' class="layui-form-label">标题：</div>
					...
					<div class="layui-form-item">
						<div :style='{"width":"120px","padding":"0 15px","lineHeight":"40px","textAlign":"right"}' class="layui-form-label">类型：</div>
					...
					<div class="layui-form-item" :style='{"alignItems":"center","margin":"0 0 10px 0","display":"flex"}'>
						<div :style='{"width":"120px","padding":"0 15px","lineHeight":"44px","textAlign":"right"}' class="layui-form-label">内容：</div>
