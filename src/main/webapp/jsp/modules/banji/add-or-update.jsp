...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑班级</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>班级管理</span></li>
				<li class="breadcrumb-item-two"><span>编辑班级</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>班级</label>
					<input name="banji" id="banji" name="banji" class="form-control" placeholder="请输入班级">
				</div>
