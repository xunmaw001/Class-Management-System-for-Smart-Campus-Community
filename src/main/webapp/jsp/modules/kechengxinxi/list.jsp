...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">课程信息管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>课程信息列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
		...
		<div id="center-container">
			...
			<div class="center-form">
				...
				<div class="form-item">
					<label>教师讲师</label>
					<input type="text" id="jiaoshijiangshiSearch" class="form-control form-control-sm" placeholder="请输入教师讲师" aria-controls="tableId">
				</div>
			...
			<table id="tableId" class="table table-bordered">
				<thead>
					<tr>
						...
						<th onclick="sort('xuefen')">学分<i id="xuefenIcon" class="fa fa-sort"></i></th>
						<th onclick="sort('shangkedidian')">上课地点<i id="shangkedidianIcon" class="fa fa-sort"></i></th>
						<th>图片</th>
						<th onclick="sort('jiaoshijiangshi')">教师讲师<i id="jiaoshijiangshiIcon" class="fa fa-sort"></i></th>
						<th>操作</th>
					</tr>
				</thead>
				<tbody></tbody>
	...
	<script>
		...
		function search(){
			...
			if($('#jiaoshijiangshiSearch').val() != null && $('#jiaoshijiangshiSearch').val() != ''){
				searchForm.jiaoshijiangshi ="%" +  $('#jiaoshijiangshiSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("kechengxinxi/page","GET",{
				...
				jiaoshijiangshi : searchForm.jiaoshijiangshi,	
			},(res)=>{
				if(res.code == 0){
					clear();
		...
		function setDataRow(item,number){
			...
			var xuefenCell  = document.createElement('td');

						 xuefenCell.innerHTML = item.xuefen;

			row.appendChild(xuefenCell);
			...
			var jiaoshijiangshiCell  = document.createElement('td');

						 jiaoshijiangshiCell.innerHTML = item.jiaoshijiangshi;

			row.appendChild(jiaoshijiangshiCell);
			var kechengbiaoCell  = document.createElement('td');
