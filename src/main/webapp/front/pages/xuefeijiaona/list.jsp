		...
		<script>
			...
			layui.use(['form', 'layer', 'element', 'carousel', 'laypage', 'http', 'jquery','laydate', 'slider'], function() {
				...
				if (jquery('#xueshengxuehao').val()) {
					...
					// 获取列表数据
					http.request('xuefeijiaona/list', 'get', param, function(res) {
