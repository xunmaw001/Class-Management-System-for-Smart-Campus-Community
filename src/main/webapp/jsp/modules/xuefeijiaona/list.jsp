...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">学费缴纳管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>学费缴纳列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
			...
			<table id="tableId" class="table table-bordered">
				<thead>
					<tr>
						...
						<th onclick="sort('jiaofeijine')">缴费金额<i id="jiaofeijineIcon" class="fa fa-sort"></i></th>
						<th>备注</th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var jiaofeijineCell  = document.createElement('td');

						 jiaofeijineCell.innerHTML = item.jiaofeijine;

			row.appendChild(jiaofeijineCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("xuefeijiaona/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"xuefeijiaona");
        ...
        function pay(item){
			...
			window.sessionStorage.setItem('tableName',"xuefeijiaona");
