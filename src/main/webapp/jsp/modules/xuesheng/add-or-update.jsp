...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑学生</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>学生管理</span></li>
				<li class="breadcrumb-item-two"><span>编辑学生</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>学生学号</label>
					<input name="xueshengxuehao" id="xueshengxuehao" name="xueshengxuehao" class="form-control" placeholder="请输入学生学号">
				</div>
				<div class="form-item">
					<label>学生姓名</label>
					<input name="xueshengxingming" id="xueshengxingming" name="xueshengxingming" class="form-control" placeholder="请输入学生姓名">
				</div>
				<div class="form-item">
					<label>密码</label>
				...
				<div class="form-item">
					<label>专业</label>
					<input name="zhuanye" id="zhuanye" name="zhuanye" class="form-control" placeholder="请输入专业">
				</div>
				<div class="form-item">
					<label>联系电话</label>
				...
				<div class="form-item">
					<label>学院</label>
					<input name="xueyuan" id="xueyuan" name="xueyuan" class="form-control" placeholder="请输入学院">
				</div>
				<div class="form-item">
					<label>班级</label>
	...
	<script>
		...
		function dataBind(){
			...
			$("#xueshengxuehao").val(ruleForm.xueshengxuehao);	
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.xueshengxuehao != null && res.data.xueshengxuehao != ''){
						...
						$("#xueshengxuehao").val(res.data.xueshengxuehao);
						$("#xueshengxuehao").attr('readonly','readonly');
					}
