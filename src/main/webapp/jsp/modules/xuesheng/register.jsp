...
<body>
	...
	<div class="content">
			<form id="registerForm" action="" method="post">
				...
				<div class="list-item">
					<input  name="xueshengxuehao"  placeholder="请输入学生学号" class="form-control-i">
				</div>
				<div class="list-item">
					<input  name="xueshengxingming"  placeholder="请输入学生姓名" class="form-control-i">
				</div>
				<div class="list-item">
				...
				<div class="list-item">
					<input  name="zhuanye"  placeholder="请输入专业" class="form-control-i">
				</div>
				<div class="list-item">
					<input  name="lianxidianhua"  placeholder="请输入联系电话" class="form-control-i">
				</div>
				<div class="list-item">
					<input  name="xueyuan"  placeholder="请输入学院" class="form-control-i">
				</div>
                <div class="list-item">
