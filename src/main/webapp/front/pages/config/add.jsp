			...
			<div class="data-add-container" :style='{"width":"100%","padding":"30px 20px 40px","margin":"10px auto","position":"relative","background":"rgba(255,255,255,.3)"}'>
				<form class="layui-form layui-form-pane add" lay-filter="myForm">
					<div :style='{"alignItems":"center","margin":"0 0 10px 0","display":"flex"}' class="layui-form-item">
						<div :style='{"width":"120px","padding":"0 15px","lineHeight":"40px","textAlign":"right"}' class="label">名称：</div>
						<input :style='{"padding":"0 10px","margin":"0","borderColor":"#9dcde9","color":"#333","outline":"none","borderRadius":"4px","borderWidth":"0 0 2px","background":"linear-gradient(320deg, rgba(204,204,204,.0) 0%, rgba(255,255,255,.9) 80%, rgba(204,204,204,.0) 100%)","width":"360px","fontSize":"14px","lineHeight":"40px","borderStyle":"dotted","height":"40px"}' v-model="detail.name" type="text" :readonly="ro.name" name="name" id="name" autocomplete="off" class="layui-input">
					</div>
					<div :style='{"alignItems":"center","margin":"0 0 10px 0","display":"flex"}' class="layui-form-item">
						<div :style='{"width":"120px","padding":"0 15px","lineHeight":"44px","textAlign":"right"}' class="label">值：</div>
						<img :style='{"width":"180px","margin":"0 10px 0 0","objectFit":"cover","height":"100px"}' v-if="detail.value" id="valueImg" :src="baseurl+detail.value">
						<input v-if="detail.value" type="hidden" :value="detail.value" id="value" name="value" />
						<button v-if="!ro.value" :style='{"cursor":"pointer","border":"0","padding":"0px 15px","margin":"0","borderColor":"#9dcde9","color":"#3086b9","outline":"none","borderRadius":"0px","background":"#fff","borderWidth":"0 0 2px","width":"auto","fontSize":"14px","lineHeight":"40px","borderStyle":"dotted","height":"40px"}' type="button" class="layui-btn btn-theme" id="valueUpload">
							<i :style='{"color":"#3086b9","margin":"0 10px 0 0","fontSize":"14px"}' class="layui-icon">&#xe67c;</i>上传值
						</button>
					</div>
